...
public class BlockRenderTest : MonoBehaviour
{
    ...
    void UpdateMeshCube()
    {
        VoxelFace frontFaceData = Voxel.getFrontFace(new Vector3(0,0,0));
        VoxelFace topFaceData = Voxel.getTopFace(new Vector3(0, 0, 0));


        List<VoxelFace> faces = new List<VoxelFace>();


        faces.Add(Voxel.getFrontFace(new Vector3(0, 0, 0)));
        faces.Add(Voxel.getTopFace(new Vector3(0, 0, 0)));
        faces.Add(Voxel.getLeftFace(new Vector3(0, 0, 0)));
        faces.Add(Voxel.getRightFace(new Vector3(0, 0, 0)));
        faces.Add(Voxel.getBottomFace(new Vector3(0, 0, 0)));
        faces.Add(Voxel.getBackFace(new Vector3(0, 0, 0)));
